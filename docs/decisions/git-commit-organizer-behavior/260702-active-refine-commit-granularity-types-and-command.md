# 2026-07-02 - 调整 git-commit-organizer 的提交粒度、类型和创建命令

## 状态
- 当前状态: active
- 导致状态变化的决策: 无
- 状态说明: 当前作为 `git-commit-organizer` skill 组织提交粒度、选择提交类型和创建提交命令的规则依据。
...
- 触发条件: 以后调整 `git-commit-organizer` 的提交粒度、提交类型边界、AI 配置提交归类或提交创建命令时, 沿用该判断。

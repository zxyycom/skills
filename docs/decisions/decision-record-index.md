...
2. [active: 2026-07-01 - 使用版本化 release 发布 skill 制品](project-tooling/260701-active-publish-versioned-skill-releases.md)
...
6. [active: 2026-07-01 - 在 skill 包内分发自更新脚本](project-tooling/260701-active-embed-self-update-script-in-skill-packages.md)
7. [amended: 2026-07-01 - 使用 skill hash 门禁 latest release 发布](project-tooling/260701-amended-gate-latest-release-by-skill-hash.md)
8. [amended: 2026-07-01 - 给子仓库增加独立 release workflow](project-tooling/260701-amended-add-submodule-release-workflows.md)
9. [amended: 2026-06-30 - 使用 latest release 自动发布 skill 制品](project-tooling/260630-amended-publish-skill-package-as-latest-release.md)

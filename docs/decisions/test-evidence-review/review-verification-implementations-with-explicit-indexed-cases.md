...
relations:
  - type: 替代
    target: test-evidence-review/260720-map-test-entries-and-trigger-scoped-reviews.md
  - type: 修订
    target: test-evidence-review/index-ledger-by-stable-case-state.md
  - type: 替代
    target: test-evidence-review/publish-only-layered-test-evidence-interfaces.md
  - type: 修订
    target: test-evidence-review/read-ledger-contract-on-demand.md
---

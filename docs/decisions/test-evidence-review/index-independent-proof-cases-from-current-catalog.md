...
relations:
  - type: 修订
    target: test-evidence-review/review-verification-implementations-with-explicit-indexed-cases.md
  - type: 归并
    target: test-evidence-review/260720-organize-proofs-by-shared-execution-chain.md
---

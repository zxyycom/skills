...
Entry:
- `tools/investigation-report/tests/index-query.test.ts > search reads published metadata without reading report sources`
- `bun test --test-name-pattern="^search reads published metadata without reading report sources$" ./tools/investigation-report/tests/run.ts`

...
- `tools/investigation-report/tests/candidate.test.ts > candidate API normalizes optional relation summaries and rejects invalid values`
- `bun test --test-name-pattern="^candidate API normalizes optional relation summaries and rejects invalid values$" ./tools/investigation-report/tests/run.ts`

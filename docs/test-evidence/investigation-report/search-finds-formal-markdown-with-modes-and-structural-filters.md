...
Entry:
- `tools/investigation-report/tests/index-query.test.ts > search finds formal Markdown with all, any, phrase, and structural filters`
- `bun test --test-name-pattern="^search finds formal Markdown with all, any, phrase, and structural filters$" ./tools/investigation-report/tests/run.ts`

...
Entry:
- `tools/task-graph/tests/store.test.ts > store check detects complete-text canonical drift`
- `bun test --test-name-pattern="^store check detects complete-text canonical drift$" ./tools/task-graph/tests/run.ts`

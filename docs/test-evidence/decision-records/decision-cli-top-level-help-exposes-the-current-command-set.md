...
Contract:
- 顶层帮助必须准确公开默认 check、candidate scaffold 源码查询、显式 new、直接重建正式索引和统一 evolve 协议，且不再公开独立 split 命令。
Proves:
- 顶层帮助包含 agent-oriented 入口、默认严格检查、候选 scaffold/body readiness、直接重建索引、new、show-candidate 与 evolve 说明。

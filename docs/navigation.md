...
| 测试证据账本 | `docs/test-evidence/cases/*.md`、`docs/test-evidence/test-evidence-index.json` | 主题 Markdown 承接最小原生测试入口的权威 case，JSON 是跨主题统一查询投影；格式与维护事务由 `skills/test-evidence-review/` 承接 |

...
assert.match(declarationSource, /DecisionSuccessor/);
assert.match(declarationSource, /DecisionRelationOverride/);
assert.match(declarationSource, /kind: "source"/);
assert.match(declarationSource, /kind: "replace"/);
assert.doesNotMatch(declarationSource, /DecisionSplitSuccessor/);

 ...
 * Maintained source: https://github.com/zxyycom/skills/blob/main/scripts/test-evidence/test-entry-regex.d.mts
 * Source path: scripts/test-evidence/test-entry-regex.d.mts

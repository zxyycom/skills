 ...
 * Maintained source: https://github.com/zxyycom/skills/blob/main/tools/task-graph/src/types.ts
 * Source path: tools/task-graph/src/types.ts
...
export declare const taskControlModes: readonly ["inherit", "candidate", "queued", "waiting", "paused"];
export declare const taskExecutionPhases: readonly ["idle", "running", "succeeded", "failed", "cancelled"];
export declare const taskEffectiveStates: readonly ["candidate", "waiting", "paused", "ready", "running", "recovery-needed", "succeeded", "failed", "cancelled"];
...
export type TaskGraphResult<TData = unknown> = TaskGraphSuccess<TData> | TaskGraphFailure;

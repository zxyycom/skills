...
[Change Plan](docs/skills/change-plan.md) 用 `proposal.md`、`design.md`、`tasks.md` 和 `.change-plan.json` 维护明确 Change 的 draft、plan 与实施进度，并通过随包 CLI 提供查询、阶段推进、Git 距离复核和完成删除。实际 skill 位于 [`skills/change-plan/`](skills/change-plan/)。

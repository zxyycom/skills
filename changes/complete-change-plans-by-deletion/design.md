...
- Decision 与 Investigation 的日期身份和 rename 由 [`adopt-date-prefixed-record-identities`](../archive/adopt-date-prefixed-record-identities/)及 [`add-record-rename-transactions`](../archive/add-record-rename-transactions/)负责；本 Change 与两者没有实施依赖。

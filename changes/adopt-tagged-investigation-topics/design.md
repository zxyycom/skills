...
- [`stage-selected-investigation-index-entries`](../../docs/decisions/archive/stage-selected-investigation-index-entries.md) 当前按路径 topic ID 选择暂存目标，资源目录的聚合 metadata 仍有独立选择边界。
